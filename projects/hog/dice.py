...
def make_fair_dice(sides):
    ...
    return dice
# return a function, when you call it, it's equal to dice once and return the outcome
...
def make_test_dice(*outcomes):
    ...
    def dice():
        nonlocal index # nonlocal can be transported to the next recursion
        index = (index + 1) % len(outcomes)
        return outcomes[index]
    return dice
# keep in mind the realization of make test dice 
# nonlocal index